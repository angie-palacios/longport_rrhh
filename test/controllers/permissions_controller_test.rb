...
class PermissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create permission" do
    assert_difference('Permission.count') do
      post permissions_url, params: { permission: { apply: @permission.apply, code: @permission.code, description: @permission.description, name: @permission.name } }
    end
  ...
  test "should update permission" do
    patch permission_url(@permission), params: { permission: { apply: @permission.apply, code: @permission.code, description: @permission.description, name: @permission.name } }
